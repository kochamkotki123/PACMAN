...
# ściany, cyfra 1 to ściana, litera C punkty, P pozycja Pacmana, 2,3,4,5 pozycje duchów i E to wyjście z tego pokoiku duchów
        ...
        self.duszek1=pygame.transform.scale(self.duszek1, (SZEROKOSC_LABIRYNTU//28, WYSOKOSC_LABIRYNTU//30))
        self.duszek2=pygame.image.load('ghost-orange.png')
        self.duszek2=pygame.transform.scale(self.duszek2, (SZEROKOSC_LABIRYNTU//28, WYSOKOSC_LABIRYNTU//30))
        self.duszek3=pygame.image.load('ghost-pink.png')
        self.duszek3=pygame.transform.scale(self.duszek3, (SZEROKOSC_LABIRYNTU//28, WYSOKOSC_LABIRYNTU//30))
        self.duszek4=pygame.image.load('ghost-blue.png')
        self.duszek4=pygame.transform.scale(self.duszek4, (SZEROKOSC_LABIRYNTU//28, WYSOKOSC_LABIRYNTU//30))
